    ...
    <div className={embedded ? "pb-24" : "min-h-screen bg-[#0B1120] pb-24"}>
      ...
      {!embedded && (
        <div className="px-5 pt-4 pb-2">
          <button onClick={onBack}
            className="text-[#C8A03A] text-sm font-medium hover:text-[#C8A03A]/80 transition-colors mb-3 flex items-center gap-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-[#6B1E2F] hover:bg-[#8A2A3F] text-white border-none rounded-lg px-3.5 py-2 text-[11px] font-semibold cursor-pointer flex items-center gap-1 shadow-[0_4px_14px_rgba(107,30,47,0.35)]"
            >
              + Nuevo
            </button>
          </div>
      ...
      {embedded && (
        <div className="px-5 pt-2 pb-1 flex items-center justify-between">
          ...
          <button
            onClick={() => setShowCreateModal(true)}
            className="bg-[#6B1E2F] hover:bg-[#8A2A3F] text-white border-none rounded-lg px-3 py-1.5 text-[11px] font-semibold cursor-pointer shadow-[0_4px_14px_rgba(107,30,47,0.35)]"
          >
            + Nuevo
          </button>
        </div>
